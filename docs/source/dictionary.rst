...
.. glossary::
  ...
  **Засада.** 
    :term:`Срабатывающая способность.` Имеет вид: «<условие>, Засада Х ». Когда выполняется <условие>, вы можете вы можете разыграть эту карту за Х монет (:term:`Альтернативная стоимость.`). Эта особенность работает из руки, а также для ваших карт, добытых вашими Яйцами, как в свой ход, так и в ход противника.
...
.. glossary::
  ...
  **Скопировать свойства и особенности (стать копией).** 
    :term:`Эффект.` Карта получает все названия, свойства и особенности копируемой карты в дополнение к своим, за исключением контролирующего игрока.  Особенности карты приобретаются, как если бы они были напечатаны на самой карте.
