...
.. glossary::
  ...
  **Иначе.** 
    Ключевое слово в составе сложной способности с использованием конструкции «Выполнить [текст Х], иначе выполнить [текст У]». Способность перейдёт к выполнению [У] только если игрок, выполняющий её, отказался или не имеет возможности полностью выполнить [Х] без применения эффектов замещения.
...
.. glossary::
  ...
  **Немертвый.** 
    :term:`Постоянная способность.` Означает «Карта получает раны только от этой особенности; в свой ход противник может закрыть Х монет и ранить эту карту на Х (любое число раз за ход)».
...
.. glossary::
  ...
  **Усилить отравление на Х.**
    Эту способность можно использовать против уже отравленных карт. Если существо обладало Отравлением У, оно заменяется Отравление Х+У.
