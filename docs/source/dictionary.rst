...
.. glossary::
  ...
  **Бесплатно.** 
    :term:`Альтернативная стоимость.` Способность или карта разыгрывается без оплаты базовой стоимости. Другие модификаторы к оплате этой способности или карты не применяются и теряются.
...
.. glossary::
  ...
  **Вместо.** 
    Ключевое слово в составе способности с использованием конструкции «Если (когда) [текст Х], вместо этого выполнить [текст У]». Способность применяется в актуальный момент, ожидая эффекта [Х], и заменяет его (полностью или частично) эффектом [У] без дополнительного занесения в очередь.
  ...
  **Входит в игру.** 
    :term:`Постоянная способность.` Карта входит в игру, когда попадает в игровую зону из любой другой (рука, кладбище, колода, запас).

  **Входит в игру с [эффект].**
     Эффект замещения. Обычный вход в игру замещается входом с эффектом или в указанном виде.
...
.. glossary::
  ...
  **Дополнительная стоимость.**
    Вариант оплаты карты, дополняющий базовую или альтернативную при розыгрыше карты. При розыгрыше к карте может быть применено несколько дополнительных стоимостей.
  ...
  **Душелов - [Текст].** 
    :term:`Постоянная способность.` [Текст] существует, только если в этом ходу погибло существо. Особенность работает в игровой зоне, руке и кладбище.
...
.. glossary::
  ...
  **Засада.** 
    :term:`Срабатывающая способность.` Имеет вид: «<условие>, Засада Х ». Когда выполняется <условие>, вы можете разыграть эту карту из руки или добытую вашим Яйцом за Х. Эта особенность работает как в свой ход, так и в ход противника.

  **Защита от [текст].** 
    Постоянная способность, порождающая эффект замещения. Карта с Защитой от [текст] не получает ран от [текст]. Исключение: защита от заклинания. Карту с защитой от заклинания не может выбрать целью игрок, контролирующий способность заклинания.
...
.. glossary::
  ...
  **Иначе.** 
    Ключевое слово в составе сложной способности с использованием конструкции «Выполнить [текст Х], иначе выполнить [текст У]». Способность перейдёт к выполнению [У] только если игрок, выполняющий её, отказался или не имеет возможности полностью выполнить [Х] без применения эффектов замещения. Невозможность заявить или выполнить [Х] в этом случае сразу приводит к выполнению [У].
...
.. glossary::
  ...
  **Контролирующий карту (способность) игрок.** 
   ...
   **Контролирующий противника игрок.**
     Игрок, контролирующий волю противника – его право совершать игродействия подконтрольными картами. 

   **Концентрация: [Текст].**
    :term:`Срабатывающая способность.` В начале вашего хода, выполните [Текст], если на этом персонаже нет ран.
...
.. glossary::
  ...
  **Набег Х - [Текст].**
    :term:`Постоянная способность.` Пока это существо атакует, и это Х или более атака за ход, оно имеет [текст]. 
  ...
  **Наибольшее (наименьшее) значение. Больше (меньше).**
    Если какая-либо способность предписывает вам взаимодействие с наибольшим (наименьшим) значением, то среди всего множества таких объектов нужно будет определить такой объект, для которого нет других объектов с большим (меньшим) значением. Если таких объектов несколько, каждый из них будет считаться наибольшим (наименьшим).

  **Наименее активный (наиболее неактивный) игрок.**
    Наименее активным игроком является последний игрок в текущем порядке хода (игрок, сидящий справа от активного). При участии в партии более двух игроков он первым объявляет защитников или срабатывающие способности.  

  **Найм: [текст].** 
    :term:`Срабатывающая способность.` [текст] выполняется, когда эта карта входит в игру.

  **Направленный удар.** 
    :term:`Постоянная способность.` От карты с направленным ударом нельзя назначить защитника.
  ...
  **Немертвый.** 
    :term:`Постоянная способность.` Означает «Эта карта получает раны только от этой особенности; в свой ход противник может закрыть Х монет и ранить эту карту на Х (любое число раз за ход)».
  ...
  **Неактивный игрок.** 
    Игрок, не являющийся Активным игроком.
...
.. glossary::
  ...
  **Оплата.** 
    Ресурсы, необходимые для использования активируемой способности. Это может быть закрытие карты, получение ран и т.д. Оплата способности происходит сразу после заявки. Нельзя заявить способность, если недостаточно ресурсов для её оплаты. По умолчанию игроки используют свои ресурсы.
  ...
  **Отдайте.** 
    Выбранная ваша карта переходит под контроль противника.
  ...
  **Отравить на Х.** 
    Персонаж получает :term:`Отравление Х.`.

  **Отравление Х.** 
    :term:`Срабатывающая способность.` Персонаж с Отравлением Х в начале своего хода получает Х ран. Если в результате выполнения каких-либо способностей карта с Отравлением Х получает Отравление У, действовать будет только Отравление с наибольшим значением.
...
.. glossary::
  ...
  **Повторить.** 
    Если способность предписывает вам повторить что-либо, вы еще раз применяете все (или только выбранные, если это указано) способности карты, которую повторяете. Если способности повторенной карты зависят от стоимости карты и эта стоимость Х, то Х принимает то же значение, что и на повторяемой карте. Вы можете выбирать новые цели для повторенной карты. Срабатывающие способности на розыгрыш заклинания не срабатывает на такое повторение заклинания (См. «Применить эффект заклинания»).
  ...
  **Подготовить [карту/карты].** 
    Откройте указанные карты. У этих карт снимаются маркеры использования 1 (Х) раз ход активируемых способностей, если эти карты - персонажи, они вновь могут атаковать ударом и выступать в защиту. 
  ...
  **Покинуть игровую зону.** 
    Вернуться из игровой зоны в колоду, руку, запас или на кладбище или быть добытым из игровой зоны.

  **Покинуть кладбище.** 
    Вернуться из кладбища в игровую зону, в колоду или руку или быть добытым из кладбища.
  ...
  **Получает [текст] (получает особенность).**
    Если прямо не указано, на какой период времени карта получает [текст] (т.е. получает приобретённую особенность) или не указаны другие условия для поддержания этого эффекта, то приобретаемый [текст] сохраняется до покидания картой игровой зоны (до конца боя, если в течение партии она не покидает игровую зону).
  ...
  **При атаке.** 
    :term:`Срабатывающая способность.`, начинающаяся со слов «при атаке», срабатывает, когда эта карта наносит :term:`Атака.`, даже если сила атаки ( выстрела ) равна 0. Не срабатывает при :term:`Ответный удар.`
  
  **При ударе.** 
    :term:`Срабатывающая способность.`, начинающаяся со слов «при ударе», срабатывает, когда эта карта наносит удар, даже если сила удара равна 0. Срабатывает при :term:`Ответный удар.`
  
  **При выстреле.** 
    :term:`Срабатывающая способность.`, начинающаяся со слов «при выстреле», срабатывает, когда эта карта наносит выстрел, даже если сила выстрела равна 0. 

  **При гибели (при уничтожении) Х** 
    :term:`Срабатывающая способность.`, начинающаяся со слов «при гибели» («при уничтожении»), срабатывает при любом переносе карты Х из игровой зоны на кладбище. Погибшая карта теряет все маркеры и эффекты только после того, как будут заявлены все особенности «при гибели»сработавшие на гибель этой карты.
  
  **При этом.** 
    Ключевая фраза в составе сложной способности с использованием конструкции «Выполнить [текст Х], при этом выполнить [текст У]», Способность перейдёт к выполнению [У] только после полного фактического выполнения [Х] без применения эффектов замещения.

  **Применить способность.** 
    Наложить эффект. См. Выполнить.

  **Применить эффект заклинания.**
    Способность заклинания проходит все этапы розыгрыша (пункт 309.1), кроме шагов 1 (определение зоны), 4 (перенос карты), 9 (оплата), которые регулируются текстом карты-источника. Шаги 10 (отмена) и 11 (розыгрыш) игнорируются.
...
.. glossary::
  ...
  **Расход X: [Текст].**
    :term:`Срабатывающая способность.` Когда вы тратите монеты, если были потрачены Х или более монет за ход, выполните [Текст]. Срабатывает один раз за ход для каждого значения расхода карты (для карт с расходом Х, Y, Z…).
...
.. glossary::
  ...
  **Упоминается.**
    Упоминанием карт являются формы упоминаемых слов и производные от него в текстах особенностей, классах и названиях карт. Упоминание классов Экипировок, Местностей и Событий является упоминанием карт поддержки.

  **Усилить отравление на Х.**
    Отравление У заменяется Отравлением Х+У.
...
.. glossary::
  ...
  **–X от атаки.** 
    :term:`Постоянная способность.` При расчёте силы атаки по этой карте, сила атаки уменьшается на X.
...
.. glossary::
  ...
  **Чешуя X.** 
    Предотвратите все раны от ударов и выстрелов силой X или менее по этой карте (с учётом модификаторов силы атаки и выстрелов). Если в результате выполнения каких-либо способностей карта с Чешуей Х получает Чешую У, действовать будет только одна Чешуя с наибольшим значением.
...
.. glossary::
  ...
  **Эффект ослабления.**
    Удар и жизни персонажа уменьшается на 1 за каждый Эффект ослабления на этом персонаже. Взаимосокращается с эффектом усиления.

  **Эффект усиления.** 
    Удар и жизни существа увеличиваются на 1 за каждый Эффект усиленияна этом существе. Взаимосокращается с эффектом ослабления.
